<template>
  ...
  <div class="flex justify-center items-center mt-4">
    <div class="max-w-3xl mx-auto p-8 bg-gray-800 rounded-lg text-white">
      ...
      <p class="mb-6">
        This app was created by Aaron Floreani in Los Angeles, CA. It was built using Vue JS, Vite, Tailwind CSS, and Pinia. The source code is available on Github. Feel free to reach out with any questions or feedback!
      </p>
